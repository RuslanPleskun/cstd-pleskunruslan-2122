...
__GIT TAG:__ `StreamingService_v2p2_WW21494`  
__User Guide:__  open file `user-guide.txt`  
__Test report:__  open folder *testReport* and the file `testReport.html`  
__What's new:__  
- Mobile/Tablet adaptation  
- Additional validation for entered data  
- Fix UI bugs  
- Update prices in the shop section  
- Tests update  

__Release version:__ ![version](https://img.shields.io/badge/version-2.2-blue)  
